package com.sapglance.app.platform
...
private const val PREFS_NAME = "sapglance_prefs"
...
val Context.sapGlanceDataStore: DataStore<Preferences> by preferencesDataStore(name = PREFS_NAME)
